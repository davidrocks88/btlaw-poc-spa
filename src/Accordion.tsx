...
export const Accordion: React.FC<AccordionProps> = ({ title, content }) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      >
        <p className=" pb-10 pl-2 text-sm text-gray-500">
          {content}
        </p>
      </div>
    </div>
